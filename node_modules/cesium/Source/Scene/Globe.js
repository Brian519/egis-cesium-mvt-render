define([
    ...
    Globe.prototype.beginFrame = function(frameState) {
        ...
        if (pass.render) {
            ...
            for ( var i = 0; i < this._imageryLayerCollection.length; ++i) {
                var layer = this._imageryLayerCollection.get(i);
                var provider = layer.get
                layer.beginFrame(frameState);
            }
