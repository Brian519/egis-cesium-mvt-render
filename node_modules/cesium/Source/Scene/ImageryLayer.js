define([
     ...
     */
    ImageryLayer.prototype._requestImagery = function (imagery, frameState) {
        var imageryProvider = this._imageryProvider;
        ...
        function doRequest() {
            ...
            var imagePromise = imageryProvider.requestImage(imagery.x, imagery.y, imagery.level, request, frameState);
    ...
    ImageryLayer.prototype.beginFrame = function (frameState) {
        if (!!this._imageryProvider.beginFrame) {
            this._imageryProvider.beginFrame(frameState);
        }
    }

    ImageryLayer.prototype.endFrame = function (frameState) {
        if (!!this._imageryProvider.endFrame) {
            this._imageryProvider.endFrame(frameState);
        }
    }
